...
<head>
    ...
    <title>Student Performence Monitoring System</title>
                                ...
                                <div id="q-holder">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-1 mb-3" align="center">
                                            <button type="button" class="btn btn-success add-mark" onclick="add_mark();"><i class="fas fa-fw fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                                <div align="center">
                                    <buttn type="button" class="btn btn-success btn-marks">Submit Mark</buttn>
                                </div>
